...
with open("app/rate-user.tsx", "r") as f:
    content = f.read()
...
content = content.replace('    const quickTags = ["Pelanggan Ramah", "Sesuai Titik Maps", "Responsif", "Komunikasi Baik"];',
...
with open("app/rate-user.tsx", "w") as f:
    f.write(content)
